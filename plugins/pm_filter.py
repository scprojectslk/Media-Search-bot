    ...
    if 2 < len(message.text) < 100:    
        ...
        if len(btn) > 10: 
            ...
            if poster:
                ...
                await message.reply_text(f"<b>ʜᴇʀᴇ ɪs ᴡʜᴀᴛ ɪ ғᴏᴜɴᴅ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ ғᴏʀ ʏᴏᴜʀ ǫᴜᴇʀʏ {search} ‌‌‌‌‎ ­  ­  ­  ­  ­  </b>", reply_markup=InlineKeyboardMarkup(buttons))
            return
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/MovieZoneUpdates'),
                    InlineKeyboardButton('ᴏᴜʀ ɢʀᴏᴜᴘ', url='https://t.me/MovieZoneLK')
                ]
                ]
            await query.message.edit(text="<b>Developer : <a href='https://t.me/SCProjectsLK'>SANU</a>\nLanguage : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\nMovie Zone : <a href='https://t.me/MovieZoneLK'>Click here</a>\nUpdate Channel : <a href='https://t.me/MovieZoneUpdates'>Movie Zone Updates</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('More Bots', url='https://t.me/SCProjectsLK'),
                        InlineKeyboardButton('Update Channel', url='https://t.me/MovieZoneUpdates')
                    ]
                    ]
        ...
        await query.answer("ᴍᴍᴍ 👀",show_alert=True)
